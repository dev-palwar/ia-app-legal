...
const CONFIG = {
    ...
    cookies: {
        essential: {
            ...
            description: "Enables basic functionality like user authentication and security features",
            required: true
        },
        performance: {
            name: "Performance Cookies",
            description: "Collects anonymous usage data to improve service performance",
            required: false
        },
        functional: {
    ...
    userRights: {
        ...
        deletion: {
            name: "Deletion",
            description: "Requests deletion of your personal data (subject to legal obligations)"
        },
        portability: {
            name: "Data Portability",
            description: "Receives your data in a structured, machine-readable format"
        },
        optOut: {
            name: "Opt-Out",
    ...
    dataCollected: {
        personal: {
            ...
            instagram: ["Instagram username", "Profile information", "Authentication tokens"],
            payment: ["Billing address", "Payment method details (processed securely through third-party payment processors)"],
            communication: ["Messages", "Comments", "Interactions you create through our platform"]
        },
        automatic: {
            usage: ["Features used", "Time spent", "Automation workflows created"],
            device: ["IP address", "Browser type", "Operating system", "Device identifiers"],
